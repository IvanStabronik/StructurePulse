...
class LiveExecutionRecord(Base):
    ...
    real_pnl: Mapped[Decimal | None] = mapped_column(Numeric(38, 18))
    real_entry_price: Mapped[Decimal | None] = mapped_column(Numeric(38, 18))
    real_exit_price: Mapped[Decimal | None] = mapped_column(Numeric(38, 18))
